 ...
 * stall per keystroke ("INSANE sluggishness" in the perf HUD). This agent host
 ...
 * Inline-calling a factory (`extensions={buildFoo()}`) is a bug -- the agent host
 ...
 * -- the agent host can't fix what it can't see.
 */
export const SafeCodeMirror = forwardRef<ReactCodeMirrorRef, SafeCodeMirrorProps>(function SafeCodeMirror(
  ...
  // Always pass the stable agent hosts: they're no-ops when the parent didn't
